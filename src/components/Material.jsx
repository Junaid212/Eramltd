            ...
            <div className="project-details-single-page">
              ...
              <div className="row gx-30 flex-row-reverse">
                <div className="col-xxl-8 col-lg-7">
                  ...
                  <p className="mb-25">
                    Throughout the history of its operations, Eram has consistently 
                    employed the requisite expertise needed for the supply of materials 
                    for projects to EPC, PMC, and end-users efficiently and effectively.
                  </p>
                  {/* <p className="mb-25">
                  ...
                  <p className="mb-20 mt-30">
                    Our dedicated Project Procurement and Expediting Managers are proficient 
                    in engineering and construction, manufacturing processes, project management, 
                    logistics channels, and supply chain management. From start to finish, clients 
                    are assured of receiving project material supply with the consistent reliability 
