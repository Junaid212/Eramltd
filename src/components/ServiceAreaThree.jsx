...
const ServiceAreaThree = () => {
  return (
    <div className="service-area-2  position-relative z-index-common">
      <div className="container">
        <div className="row gy-2 justify-content-center">
          ...
          <div className="col-xxl-8 col-xl-7 col-sm-6">
            <div className="row global-carousel service-client-slider" style={{marginTop:'-130px'}}>
              <Swiper
                loop={true}
