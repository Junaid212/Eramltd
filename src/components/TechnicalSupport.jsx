            ...
            <div className="project-details-single-page">
              ...
              <div className="row gx-30 flex-row-reverse">
                <div className="col-xxl-8 col-lg-7">
                  ...
                  <p className="mb-25">
                  Eram’s technical support team complements its operations with services 
                  ranging from inspection of materials at the source and throughout the 
                  supply chain all the way to final documentation. The team includes NDE 
                  level II certified engineers and welding specialists for technical support 
                  and quality control at all stages of our value chain.
                  </p>
                  {/* <p className="mb-25">
                  ...
                  <p className="mb-20 mt-30">
                        At Eram, we work closely with our customers to ensure that 
                        the requisite services needed for their piping solutions are 
                        handled with expert care. We invest in a wide range of capabilities 
                        to complement our supply logistics and to provide the necessary 
                        services relevant to their requirements.
                   </p>
                </div>
