        ...
        <div className="row gy-4 justify-content-center">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="/assets/img/icon/service-icon_1-4.svg" alt="Eram" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="/assets/img/service/service-1-4.png" alt="Eram" />
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="/assets/img/icon/service-icon_1-5.svg" alt="Eram" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="/assets/img/service/service-1-5.png" alt="Eram" />
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="service-card style-shadow">
              <div className="service-card_content">
                <div className="service-card_icon">
                  <img src="/assets/img/icon/service-icon_1-6.svg" alt="Eram" />
                </div>
                <h4 className="service-card_title h5">
              ...
              <div className="service-card_img">
                <img src="/assets/img/service/service-1-6.png" alt="Eram" />
              </div>
            </div>
          </div>
        </div>
