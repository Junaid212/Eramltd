      ...
      <div className="container">
        ...
        <div className="widget-area">
          <div className="row justify-content-between">
              ...
              <div className="widget widget_nav_menu footer-widget">
                ...
                <div className="menu-all-pages-container">
                  <ul className="menu">
                    ...
                    <li>
                      <Link to="/electrical/about">About Us</Link>
                    </li>
                    <li>
                      <Link to="/electrical/products">Products</Link>
                    </li>
                    <li>
                      <Link to="/electrical/contact">Contact Us</Link>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-md-6 col-xl-auto">
              <div className="widget widget_nav_menu footer-widget">
                <h3 className="widget_title">Other</h3>
                <div className="menu-all-pages-container">
                  <ul className="menu">
                    <li>
                ...
                <div className="widget-contact2">
                  ...
                  <div className="widget-contact-grid">
                    ...
                    <div className="contact-grid-details">
                      <p>Phone Number</p>
                      <h6>
                        <Link to="tel:+966 59 276 9880">+966 59 276 9880</Link>
                        <p />
                      </h6>
                    </div>
                  </div>
                  <div className="widget-contact-grid">
                    ...
                    <div className="contact-grid-details">
                      <p>Email Address</p>
                      <h6>
                        <Link to="mailto:showroom@eramltd.com">
