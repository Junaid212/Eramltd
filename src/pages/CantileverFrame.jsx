...
const CantileverFrame = () => {
  ...
  return (
    <>
      ...
      {/* Breadcrumb */}
      <Breadcrumb title={"Cantilever Frame & Korean Frame Systems"} />
                ...
                <div className="col-xxl-8 col-lg-7">
                  <div className="service-page-single">
                    ...
                    <div className="page-content">
                      <h2 className="page-title">Cantilever Frame & Korean Frame Systems</h2>
                      <p className="mb-25">
                       Cantilever and Korean frame systems are designed to extend 
                       scaffolding structures beyond standard support areas, making 
                       them ideal for complex construction projects. Eram Company Ltd 
                       offers highly durable and customizable cantilever frame systems 
                       that provide additional reach and support for challenging work 
                       environments.{" "}
                      </p>
                      ...
                      <p className="mb-30">
                       Our Korean frame systems are specifically engineered for 
                       projects requiring enhanced structural stability and quick 
                       installation. These frames are widely used in industrial, 
                       commercial, and residential construction due to their 
                       adaptability and high load-bearing capacity. With our expert 
                       solutions, clients can ensure optimal performance and worker 
                       safety.{" "}
                      </p>
                        {/* <ul>
                          <li>
...
export default CantileverFrame;
