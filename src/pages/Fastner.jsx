...
export default function Fastner() {
  const stainlessSteelData = [
    { label: 'Size', value: 'Black' },
    { label: 'Schedule', value: 'Galvenized' },
    { label: 'Stainless Steel', value: 'Coated' },
  ];

  const carbonSteelData = [
    {  value: 'STM A193 B7, B16, B8, B8M - Alloy Steel' },
    // {  value: '10S / 40S / 80S / 160S / XXS' },
  ];
