...
export default function ButtWeldFittings() {
  const stainlessSteelData = [
    { label: 'Size', value: '1/2" NB to 36" NB, ANSI B 16.9, MSS-SP-43' },
    { label: 'Schedule', value: '10S / 40S / 80S / 160S / XXS' },
    { label: 'Stainless Steel', value: 'ASTM A 403 409 - TP 304/304H/304L 316/316H/316L/316Ti/309/310 317L/321/347/904L' },
    { label: 'Duplex Steel', value: 'ASTM A815 UNS S31803, S32750, S32760, S32205' }
  ];

  const carbonSteelData = [
    { label: 'Size', value: '1/2" NB to 58" NB, ANSI B 16.9' },
    { label: 'Schedule', value: '10S / 40S / 80S / 160S / XXS' },
    { label: 'Carbon Steel', value: 'ASTM A 234 WPB, IS 1239 PART II' },
    { label: 'Alloy Steel', value: 'ASTM A 234 WPB WP95, WP9, WP11, WP12, WP91' },
    { label: 'Low Temp. CS', value: 'ASTM A-420 WPL6' },
    { label: 'Other Services', value: 'Hot Dip Galvanizing, Sand Blasting' }
  ];

  const copperNickelData = [
    { label: 'Size', value: '1/2" to 12"' },
    { label: 'Schedule', value: '10S / 40S / 80S' },
    { label: 'Materials', value: 'C70600 (90:10), C71500 (70:30), Nickel/Monel/Inconel/Hastelloy' }
  ];

  const fittingTypes = [
    { title: 'Elbow (45°, 90°, 180°)', icon: Wrench },
    { title: 'Stubend (Long & Short)', icon: Package },
    { title: 'TEE (Barred, Equal, Reducing)', icon: Layers },
    { title: 'U Bend', icon: Settings },
    { title: 'Reducer (Concentric & Eccentric)', icon: Shield },
    { title: 'End Cap', icon: CheckCircle2 },
    { title: 'Nipple (Swage & Barrel)', icon: Factory },
    { title: 'Laterals', icon: Zap }
  ];
      ...
      <section className="section-padding">
        <div className="section-container">
          ...
          <div className="grid-2-col mb-8">
            <SpecificationCard
              title="Stainless Steel & Duplex Steel"
              icon={Shield}
            ...
            <SpecificationCard
              title="Carbon Steel, Alloy Steel & LTCS"
              icon={Layers}
